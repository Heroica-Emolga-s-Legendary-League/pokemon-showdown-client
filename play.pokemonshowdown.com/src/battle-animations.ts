...
export class PokemonSprite extends Sprite {
	...
	protected static statusTable: { [id: string]: [string, 'good' | 'bad' | 'neutral'] | null | string } = {
		...
		// Custom
		atlantisblessingatk: ['Atlantis Blessing: Atk', 'good'],
		atlantisblessingdef: ['Atlantis Blessing: Def', 'good'],
		atlantisblessingspa: ['Atlantis Blessing: SpA', 'good'],
		atlantisblessingspd: ['Atlantis Blessing: SpD', 'good'],
		atlantisblessingspe: ['Atlantis Blessing: Spe', 'good'],
		lithogritatk: ['Lithogrit: Atk', 'good'],
		lithogritdef: ['Lithogrit: Def', 'good'],
		lithogritspa: ['Lithogrit: SpA', 'good'],
		lithogritspd: ['Lithogrit: SpD', 'good'],
		lithogritspe: ['Lithogrit: Spe', 'good'],
		tundracoreatk: ['Tundra Core: Atk', 'good'],
		tundracoredef: ['Tundra Core: Def', 'good'],
		tundracorespa: ['Tundra Core: SpA', 'good'],
		tundracorespd: ['Tundra Core: SpD', 'good'],
		tundracorespe: ['Tundra Core: Spe', 'good'],
		pureharvestatk: ['Pure Harvest: Atk', 'good'],
		pureharvestdef: ['Pure Harvest: Def', 'good'],
		pureharvestspa: ['Pure Harvest: SpA', 'good'],
		pureharvestspd: ['Pure Harvest: SpD', 'good'],
		pureharvestspe: ['Pure Harvest: Spe', 'good'],
		psychoritualatk: ['Psycho Ritual: Atk', 'good'],
		psychoritualdef: ['Psycho Ritual: Def', 'good'],
		psychoritualspa: ['Psycho Ritual: SpA', 'good'],
		psychoritualspd: ['Psycho Ritual: SpD', 'good'],
		psychoritualspe: ['Psycho Ritual: Spe', 'good'],
		mysticzoneatk: ['Mystic Zone: Atk', 'good'],
		mysticzonedef: ['Mystic Zone: Def', 'good'],
		mysticzonespa: ['Mystic Zone: SpA', 'good'],
		mysticzonespd: ['Mystic Zone: SpD', 'good'],
		mysticzonespe: ['Mystic Zone: Spe', 'good'],
		dragonstorm: ['Dragon Storm Storm', 'bad'],
		perish4: ['Perish in 4', 'bad'],
		perish5: ['Perish in 5', 'bad'],
		perish6: ['Perish in 6', 'bad'],
	};
	forme = '';
